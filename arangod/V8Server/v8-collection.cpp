...
static void DocumentVocbaseCol(
  ...
  if (useCollection) {
    ...
    col = TRI_UnwrapCollection(args.Holder());
...
static TRI_vocbase_col_t const* UseCollection(
  ...
  TRI_vocbase_col_t* col = TRI_UnwrapCollection(collection);
...
static void JS_NameVocbaseCol(v8::FunctionCallbackInfo<v8::Value> const& args) {
  ...
  TRI_vocbase_col_t const* collection = TRI_UnwrapCollection(args.Holder());
